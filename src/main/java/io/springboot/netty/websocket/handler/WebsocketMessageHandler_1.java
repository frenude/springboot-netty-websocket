...
@Sharable
@Component
public class WebsocketMessageHandler_1 extends SimpleChannelInboundHandler<WebSocketFrame> {
...
//            this.discardService.discard(textWebSocketFrame.text());
            // 响应客户端
            ctx.channel().writeAndFlush(new TextWebSocketFrame("我收到了你的消息_1：" + System.currentTimeMillis()));
        } else {
            // 不接受文本以外的数据帧类型
